...
from conll_metric import evaluate_coreference
from allennlp.predictors.predictor import Predictor
from speaker_clusters import heuristic_coreference_resolution
import random
...
if __name__ == "__main__":
    ...
    coreference_model(parsed_file, coref_file, cuda_device, use_speaker_sep, keep_only_speaker_gold_clusters, remove_singleton_gold_clusters)