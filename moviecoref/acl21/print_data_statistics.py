...
def print_data_statistics_all():
    ...
    print_data_statistics("data/annotation/shawshank.coref.csv", "data/annotation/shawshank.script.txt")
    print()

    print("Bourne Ultimatum:")
    print_data_statistics("data/annotation/bourne.coref.csv", "data/annotation/bourne.script.txt")
    print()

    print("Inglourious Basterds:")
    print_data_statistics("data/annotation/basterds.coref.csv", "data/annotation/basterds.script.txt")
