...
from coref.movie_coref.distributed_coreference_trainer import CoreferenceTrainer
...
flags.DEFINE_bool("log_to_file", default=True, help="if true, don't log to file")
flags.DEFINE_bool("log_to_latest", default=False, help="if true, log to 'latest.log' and don't create new log file.")
...
# Validators
flags.register_validator("train_document_len", lambda x: x in [1024, 2048, 3072, 4096, 5120], message="train_document_len should be one of 2048, 3072, 4096, or 5120")
flags.register_validator("eval_document_len", lambda x: x is None or x in [1024, 2048, 3072, 4096, 5120], message="eval_document_len should be None or one of 2048, 3072, 4096, or 5120")
